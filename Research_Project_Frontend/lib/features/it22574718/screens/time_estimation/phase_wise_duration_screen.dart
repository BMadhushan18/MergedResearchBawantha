...
import 'package:boq_frontend/features/it22172532/models/phase_result.dart';
import 'package:boq_frontend/features/it22172532/components/navigation/app_navigation_shell.dart';
...
class _PhaseWiseDurationScreenState extends State<PhaseWiseDurationScreen> {
  ...
  Future<void> _bootstrap() async {
    try {
      await context.read<ProjectProvider>().ensureCurrentProject(widget.pid);
      ...
      bottomNavigationBar: _BottomNavBar(
        ...
        onItemTap: (barPos) {
          if (barPos == 2) {
            ...
            if (pageIndex == 3) {
              // Open Progress inside AppNavigationShell so shared bottom nav is visible.
              context.read<ProjectProvider>().selectProject(widget.pid);
              Navigator.pushReplacement(
                context,
                MaterialPageRoute(
                  builder: (_) => const AppNavigationShell(initialIndex: 3),
                ),
              );
            } else {
              Navigator.push(
...
// â”€â”€â”€ Custom Bottom Nav Bar â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
class _BottomNavBar extends StatelessWidget {
  ...
  // bar position â†’ page index (camera is action so -1)
        ...
        child: Padding(
          ...
          child: Row(
            ...
            children: List.generate(items.length, (i) {
              ...
              if (item.isCenter) {
                // â”€â”€ Raised camera button â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
              ...
              // â”€â”€ Regular nav item â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
              return GestureDetector(
                onTap: () => onItemTap(i),
